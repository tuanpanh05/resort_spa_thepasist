...
start "Backend - Spring Boot (Port 8080)" cmd /k "cd 05-Development\backend && .\maven\apache-maven-3.9.6\bin\mvn.cmd spring-boot:run"

:: 4. Khoi dong Frontend
echo [2/2] Dang khoi dong Frontend (Vite - React)...
start "Frontend - Vite (Port 5173)" cmd /k "cd 05-Development\frontend && npm run dev"
