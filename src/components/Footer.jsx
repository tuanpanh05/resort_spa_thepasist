...
export default function Footer() {
  ...
  if (location.pathname.startsWith('/admin') || location.pathname.startsWith('/staff') || location.pathname.startsWith('/chef') || location.pathname.startsWith('/specialist')) {
    return null;
  }
  return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 pb-16 border-b border-white/10">
          ...
          <div className="space-y-6">
            ...
            <div className="flex space-x-4">
              <a href="#" aria-label="Facebook" className="p-2 bg-white/5 hover:bg-white hover:text-sage-950 rounded-full transition-all duration-300 text-white">
                <svg className="h-5 w-5 fill-current" viewBox="0 0 24 24">
                  <path d="M22 12c0-5.52-4.48-10-10-10S2 6.48 2 12c0 4.84 3.44 8.87 8 9.8V15H8v-3h2V9.5C10 7.57 11.57 6 13.5 6H16v3h-2c-.55 0-1 .45-1 1v2h3v3h-3v6.95c4.56-.93 8-4.96 8-9.75z" />
                </svg>
              </a>
              <a href="#" aria-label="Instagram" className="p-2 bg-white/5 hover:bg-white hover:text-sage-950 rounded-full transition-all duration-300 text-white">
              ...
              <a href="#" aria-label="Youtube" className="p-2 bg-white/5 hover:bg-white hover:text-sage-950 rounded-full transition-all duration-300 text-white">
                <svg className="h-5 w-5 stroke-current fill-none" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-3.5 text-sm font-light text-white/80">
              ...
              <li><Link to="/#services" className="hover:text-white transition-colors">Dịch vụ trị liệu</Link></li>
              <li><Link to="/phong-o" className="hover:text-white transition-colors">Phòng nghỉ dưỡng</Link></li>
              <li><Link to="/#booking" className="hover:text-white transition-colors">Đặt lịch tư vấn</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3.5 text-sm font-light text-white/80">
              <li><span className="hover:text-white cursor-default transition-colors">Ẩm thực thực dưỡng organic</span></li>
              <li><span className="hover:text-white cursor-default transition-colors">Massage & Spa thảo dược</span></li>
              <li><span className="hover:text-white cursor-default transition-colors">Yoga thở & Thiền định phục hồi</span></li>
              <li><span className="hover:text-white cursor-default transition-colors">Vật lý trị liệu cột sống</span></li>
            </ul>
          </div>
