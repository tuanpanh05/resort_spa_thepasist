...
export const chefInitialDishes = [
  {
    ...
    category: "Khai vị",
    description:
      "Yến mạch organic kết hợp nhân sâm Hàn Quốc, kỷ tử và táo đỏ giúp bổ khí huyết.",
    ingredients: "Yến mạch (50g), Nhân sâm (10g), Táo đỏ (2 quả), Kỷ tử (5g)",
    allergens: [],
    isTodayMenu: true,
    period: "Breakfast",
    soldOut: false,
  ...
  {
    id: "DSH-02",
    name: "Mì căn xào sả ớt thực dưỡng",
    price: "280,000đ",
    category: "Món chính",
    description: "Mì căn dai ngon xào sả bằm và ớt hiểm, ăn kèm cơm gạo lứt.",
    ingredients: "Mì căn chay (150g), Sả (2 củ), Ớt hiểm (1 quả), Hạt nêm chay",
    allergens: ["Cay"],
    isTodayMenu: true,
    period: "Lunch",
    soldOut: false,
  ...
  {
    id: "DSH-03",
    name: "Nấm nướng lá lốt cốt dừa",
    price: "320,000đ",
    category: "Món chính",
    description:
      "Nấm đùi gà cuộn lá lốt nướng than hoa, rưới sốt nước cốt dừa béo ngậy.",
    ingredients:
      "Nấm đùi gà (100g), Lá lốt (10 lá), Nước cốt dừa (30ml), Đậu phộng rang",
    allergens: ["Đậu phộng"],
    isTodayMenu: true,
    period: "Dinner",
    soldOut: false,
  ...
  {
    id: "DSH-04",
    name: "Salad bơ hạt diêm mạch",
    price: "350,000đ",
    category: "Món chính",
    description:
      "Bơ sáp lát mỏng trộn hạt diêm mạch (quinoa), cà chua bi và nước sốt chaim leo chua thanh.",
    ingredients:
      "Bơ sáp (0.5 quả), Hạt diêm mạch (30g), Cà chua bi (50g), Chanh leo",
    allergens: [],
    isTodayMenu: true,
    period: "Lunch",
    soldOut: false,
  ...
  {
    id: "DSH-05",
    name: "Gỏi cuốn chay sốt tương lạc",
    price: "190,000đ",
    category: "Khai vị",
    description:
      "Gỏi cuốn rau sống, đậu hũ chiên và bún tươi, chấm sốt tương đen pha bơ lạc.",
    ingredients: "Đậu hũ (50g), Rau thơm, Bánh tráng, Tương đen, Bơ đậu phộng",
    allergens: ["Đậu phộng"],
    isTodayMenu: false,
    period: "Lunch",
    soldOut: false,
  ...
  {
    id: "DSH-06",
    name: "Lẩu nấm Ngũ Sơn chay",
    price: "850,000đ",
    category: "Món chính",
    description:
      "Nước dùng lẩu hầm từ củ quả ngọt lịm ăn kèm 5 loại nấm tươi quý hiếm.",
    ingredients:
      "Nấm mối chay (50g), Nấm kim châm (50g), Nấm đùi gà (50g), Củ cải, Cà rốt",
    allergens: [],
    isTodayMenu: false,
    period: "Dinner",
    soldOut: false,
  ...
  {
    id: "DSH-07",
    name: "Tôm rim tỏi ớt (Món mặn)",
    price: "390,000đ",
    category: "Món chính",
    description:
      "Tôm sú biển tươi ngon rim tỏi ớt thơm lừng cay cay ngọt ngọt.",
    ingredients: "Tôm sú (150g), Tỏi bằm, Ớt hiểm, Gia vị cốt biển",
