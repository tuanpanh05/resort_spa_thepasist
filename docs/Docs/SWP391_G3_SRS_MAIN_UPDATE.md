...
Service    Cross-references  the  guest’s  personal  health  profile  with  menu  ingredients  to  automatically  filter  out  unsafe  dishes  and  present  a  personalized,  allergy-safe  meal  selection.   
...
II.  Functional  Requirements  1.  Authen  và  Author    1.1  Login  
 On  this  screen,  users  can  
●  Input  their  email  or  phone  number.  ●  Input  their  password.  ●  Select  the  Remember  Me  checkbox.  ●  Click  the  Login  button  to  access  the  system.  ●  Click  Forgot  Password  to  reset  their  password.  ●  Click  Google  /  Facebook  /  Apple  buttons  for  social  login.  ●  Click  Register  to  create  a  new  account.  
Field  Description  
...
On  this  screen,  users  can  
●  Input  their  full  name.  ●  Input  their  email  address.  ●  Input  their  phone  number.  ●  Input  and  confirm  their  password.  ●  Show  or  hide  password  fields  while  typing.  ●  Accept  the  terms  and  privacy  policy.  ●  Click  the  Create  Account  button  to  register.  ●  Use  social  registration  options.  ●  Navigate  to  the  Login  screen.  
Field  Description  
Field  Name  Description  
...
On  this  screen,  users  can  
●  Input  their  email  or  phone  number.  ●  Request  an  OTP  verification  code.  ●  Input  the  OTP  code  received  via  email  or  SMS.  
...
●  Input  a  new  password.  ●  Confirm  the  new  password.  ●  Toggle  password  visibility.  ●  Click  the  Reset  Password  button  to  complete  the  process.  ●  Navigate  back  to  the  Login  page.  
Field  Description  
Field  Name  Description  
Email  /  Phone  Input   Allows  users  to  enter  their  email  address  or  phone  number   
...
●  View  all  selected  rooms  and  services  before  payment  ●  Review  booking  information  such  as  check-in  date,  duration,  and  guest  quantity  ●  Increase  or  decrease  the  quantity  of  selected  services  
...
●  Remove  rooms  or  services  from  the  cart  ●  View  the  payment  summary  including  subtotal,  taxes,  and  total  amount  ●  Continue  browsing  and  adding  more  services  or  rooms  ●  Proceed  to  the  payment  process  through  VNPay  ●  Review  cancellation  policy  and  booking  notes  before  checkout  
Field  Description  
Field  Name  Description  
...
●  View  the  overall  operational  status  of  the  resort  system  ●  Monitor  total  bookings,  revenue,  occupancy  rate,  and  customer  statistics  ●  Track  room  status  such  as  available,  occupied,  cleaning,  or  maintenance  ●  View  recent  activities  happening  across  the  resort  ●  Monitor  recent  bookings  and  customer  reservation  status  ●  Review  customer  feedback  and  rating  statistics  ●  Monitor  payment  statistics  and  transaction  summaries  ●  Access  quick  actions  for  common  management  tasks  ●  View  notifications  and  important  system  alerts  ●  Navigate  to  all  management  modules  such  as  Booking,  Room,  Customer,  Staff,  Service,  
Promotion,
...
Reports
 ●  Monitor  staff  performance  and  operational  efficiency  ●  View  occupancy  trends  and  revenue  analytics  over  time  ●  Check  system  alerts  related  to  rooms,  bookings,  or  maintenance  
●
...
Admin  users  can  do  on  this  screen  
●  View  and  manage  all  blog  posts  in  the  system  
...
●  Create  new  blog  posts  ●  Edit  existing  blog  posts  ●  Delete  blog  posts  ●  Publish  or  unpublish  blog  content  ●  Manage  blog  categories  and  tags  ●  View  blog  status  such  as  published  or  draft  ●  Monitor  blog  views  and  engagement  statistics  ●  Filter  blog  posts  by  category,  status,  or  publish  date  ●  Search  blog  posts  quickly  using  keywords  ●  Manage  blog  comments  and  user  interactions  ●  View  featured  or  trending  blog  posts  ●  Access  media  library  for  blog  images  and  content  assets  ●  Navigate  to  related  content  management  modules  
Field  Description  
Field  Name  Description  
...
●  Browse  all  blog  posts  published  by  the  resort  ●  Read  travel  tips,  resort  news,  promotions,  and  event  articles  ●  Search  blog  posts  by  keywords  ●  Filter  blog  posts  by  category  ●  View  featured  or  popular  blog  articles  ●  Navigate  through  multiple  blog  pages  ●  Access  detailed  blog  content  by  selecting  a  blog  post  ●  Explore  resort  activities,  experiences,  and  updates  ●  Access  social  media  and  resort  information  links  
Field  Description  
Field  Name  Description  
...
●  View  overall  business  and  operational  statistics  of  the  resort  ●  Monitor  revenue,  booking  volume,  occupancy  rate,  and  customer  growth  ●  Analyze  business  performance  through  charts  and  analytics  panels  ●  Track  room  occupancy  and  service  performance  over  time  ●  View  customer  satisfaction  and  feedback  statistics  ●  Monitor  recent  transactions  and  payment  activities  ●  Compare  revenue  and  booking  trends  by  date  or  period  ●  Export  reports  in  PDF  or  Excel  format  
...
●  Filter  reports  by  report  type,  date  range,  or  branch/location  ●  Monitor  service  efficiency  across  departments  such  as  Spa,  Restaurant,  and  Rooms  ●  Analyze  booking  sources  and  payment  methods  ●  View  top-performing  rooms  or  services  ●  Access  quick  report  shortcuts  for  specific  operational  reports  ●  Navigate  to  other  management  modules  from  the  admin  sidebar  
Field  Description  
Field  Name  Description  
...
●  View  personal  account  information  ●  Update  profile  information  such  as  name,  phone  number,  address,  and  nationality  ●  View  account  details  and  membership  status  ●  Change  account  password  securely  ●  View  account  activity  and  registration  information  ●  Save  profile  changes  ●  Cancel  editing  actions  if  needed  
Field  Description  
Field  Name  Description  
...
●  View  an  overview  of  the  resort  and  main  navigation  links.  ●  View  available  rooms  in  the  resort  along  with  their  descriptions.  ●  View  featured  rooms.  ●  View  ongoing  special  offers/promotions  of  the  resort.  
Field  Description  
Field  Name  Description  
Navigation  Menu   Cho  phép  người  dùng  điều  hướng  đến  các  trang  chính  như  Trang  chủ,  Blog,  Phòng  ở,  Spa,  Nhà  hàng,  Hội  nghị  hội  thảo,  Yoga,  Vật  lý  trị  liệu,  Khuyến  mãi  và  Thư  viện  ảnh   
Login/Register  Button   Cho  phép  người  dùng  đăng  nhập  hoặc  đăng  ký  tài  khoản   
Banner   Hiển  thị  hình  ảnh  lớn  giới  thiệu  tổng  quan  về  resort   
Room  Review  Section   Khu  vực  hiển  thị  các  phòng  nổi  bật  hoặc  phòng  được  gợi  ý   
Footer  Contact  Information   
Hiển  thị  thông  tin  liên  hệ  của  resort  như  địa  chỉ,  email  và  số  điện  thoại   
Social  Media  Links   Hiển  thị  các  liên  kết  mạng  xã  hội  của  resort   
...
This  screen  allows  users  to:  
●  View  detailed  room  information,  including  room  name,  description,  images,  and  accompanied  
amenities.
 ●  View  the  room's  image  gallery  via  main  and  secondary  photos.  ●  View  room  capacity,  bed  type,  balcony,  Wi-Fi,  air  conditioning,  and  other  facilities.  ●  Select  check-in  date,  check-out  date,  and  the  number  of  guests.  ●  Book  a  room  by  clicking  the  "Book  Now"  button.  ●  Add  a  room  to  the  wishlist/favorites  list.  ●  View  an  overview  of  customer  reviews,  including  average  rating,  star  rating,  and  total  number  of  
reviews.
 ●  View  ratings  broken  down  by  criteria  such  as  cleanliness,  service,  amenities,  and  location.  ●  Filter  reviews  by  star  rating,  reviews  with  images,  or  all  reviews.  ●  Sort  the  review  list  by  time  (recency)  or  relevance.  ●  View  detailed  review  content  from  individual  customers.  ●  View  images  attached  to  reviews  by  customers.  ●  View  the  resort's  responses  to  customer  reviews.  ●  Click  "Helpful"  if  the  review  supports  their  booking  decision.  ●  View  more  reviews  by  clicking  the  "View  More  Reviews"  button.  ●  Navigate  through  pages  in  the  review  list.  
...
Users  can  do  on  this  screen  
●  View  all  favorite  rooms  and  services  saved  in  the  wishlist  ●  Browse  saved  rooms,  spa  services,  restaurant  packages,  and  promotions  ●  Search  wishlist  items  by  keyword  ●  Filter  wishlist  items  by  category  ●  View  room  or  service  details  before  booking  ●  Book  rooms  or  services  directly  from  the  wishlist  ●  Remove  items  from  the  wishlist  ●  View  ratings  and  reviews  of  saved  services  ●  Navigate  through  multiple  wishlist  pages  
Field  Description  
Field  Name  Description  
...
Admin  users  can  do  on  this  screen  
●  View  and  manage  all  promotion  campaigns  in  the  resort  system  ●  Create  new  promotions  and  discount  campaigns  ●  Edit  promotion  information  and  discount  conditions  ●  Activate  or  deactivate  promotions  ●  Monitor  promotion  usage  and  performance  statistics  ●  Filter  promotions  by  status,  type,  or  date  range  ●  Search  promotions  by  promotion  code  ●  View  coupon  preview  before  publishing  ●  Monitor  promotion  expiration  dates  and  availability  ●  Manage  discount  percentages,  fixed  discounts,  and  service-based  promotions  ●  Track  promotion  usage  quantity  and  remaining  quota  ●  View  promotion  details  and  application  conditions  ●  Delete  expired  or  unused  promotions  
Field  Description  
Field  Name  Description  
...
User  can  do  on  this  screen  
●  View  all  available  promotions  and  special  offers  from  the  resort  ●  Browse  discounts  for  rooms,  spa  services,  restaurants,  and  combo  packages  ●  Search  promotions  by  keyword  ●  Filter  promotions  by  category  such  as  Room,  Spa,  Restaurant,  or  Combo  ●  Sort  promotions  by  newest  or  current  status  ●  View  promotion  details  and  discount  conditions  ●  Copy  or  save  promotion  codes  for  booking  ●  Apply  promotions  directly  during  booking  ●  View  promotion  validity  dates  and  discount  percentages  ●  Navigate  through  multiple  promotion  pages  
Field  Description  
Field  Name  Description  
...
Users  can  do  on  this  screen  
●  Select  VNPay  as  the  payment  method  
...
●  Scan  the  QR  code  to  complete  payment  ●  Pay  using  ATM  card,  Visa,  Mastercard,  or  QR  Pay  ●  View  payment  information  before  confirming  payment  ●  Review  the  total  payment  amount  ●  View  transaction  ID  and  payment  expiration  time  ●  Accept  VNPay  payment  terms  and  conditions  ●  Confirm  and  proceed  with  payment  ●  Return  to  the  previous  booking  or  cart  page  if  needed  
Field  Description  
Field  Name  Description  
...
Users  can  do  on  this  screen  
●  Book  Spa  and  Physical  Therapy  services  online  ●  Select  Spa  or  Physical  Therapy  categories  ●  Choose  preferred  treatment  services  ●  Select  booking  date  from  the  calendar  ●  Choose  available  time  slots  ●  Enter  personal  booking  information  ●  Add  additional  booking  notes  or  special  requests  ●  Review  booking  summary  before  confirmation  ●  Confirm  or  reset  the  booking  process  
Field  Description  
Field  Name  Description  
...
●  View  and  manage  employee  work  schedules  ●  Monitor  schedules  for  Spa,  Receptionist,  Chef,  and  other  departments  ●  Create  new  work  shifts  for  employees  ●  View  schedules  in  daily,  weekly,  or  monthly  calendar  mode  ●  Assign  employees  to  specific  shifts  and  departments  ●  Track  employee  availability  and  working  hours  ●  View  detailed  shift  information  and  assigned  tasks  ●  Filter  schedules  by  department  or  employee  ●  Approve  or  reject  shift  change  requests  ●  Monitor  absent  staff  and  replacement  shifts  ●  Synchronize  schedules  with  Google  Calendar  API  ●  Send  notifications  to  employees  about  schedule  updates  ●  Manage  overlapping  schedules  and  workforce  allocation  
Field  Description  
Field  Name  Description  
...
Admin  can  do  on  this  screen  
●  Monitor  real-time  work  status  across  departments  ●  Track  tasks  for  Spa,  Receptionist,  and  Chef/Bếp  staff  ●  View  pending,  in-progress,  completed,  and  overdue  tasks  ●  Assign  new  tasks  to  employees  ●  Update  task  status  and  work  progress  ●  Monitor  department  workload  distribution  ●  View  detailed  task  information  and  assigned  staff  ●  Filter  tasks  by  department,  status,  or  priority  ●  Track  daily  operational  activities  and  workflow  updates  ●  Manage  urgent  or  high-priority  tasks  ●  Coordinate  communication  between  departments  ●  View  activity  logs  and  employee  task  history  
...
Admin  users  can  do  on  this  screen  
●  Manage  dietary  and  special  food  requests  from  guests  ●  View  meal  preparation  status  in  real  time  ●  Monitor  urgent  or  allergy-related  food  requests  ●  Track  food  preparation  and  delivery  progress  ●  Assign  dietary  requests  to  kitchen  or  F&B  staff  ●  View  customer  dietary  restrictions  and  allergies  ●  Update  order  preparation  status  ●  Filter  requests  by  meal  type,  delivery  status,  or  dietary  condition  ●  Monitor  popular  dietary  menu  items  ●  Print  food  preparation  orders  for  kitchen  operations  ●  Coordinate  communication  between  kitchen  and  service  staff  ●  Complete  and  close  dietary  service  requests  
...
Users  can  do  on  this  screen  
●  Register  additional  resort  services  before  or  during  their  stay  ●  Select  Spa,  Room  Service,  F&B,  Yoga,  or  Physical  Therapy  services  ●  Enter  preferred  booking  date  and  time  ●  Specify  the  number  of  guests  for  the  service  ●  Customize  food  preferences  and  meal  options  ●  Inform  the  resort  about  allergies  or  dietary  restrictions  ●  Add  special  requests  or  personal  notes  ●  Submit  service  registration  information  to  the  resort  ●  Reset  and  re-enter  the  form  if  needed  
...
Users  can  do  on  this  screen  
●  Browse  retreat  and  wellness  packages  offered  by  the  resort  ●  Filter  retreat  packages  by  goals  such  as  Weight  Loss,  Stress  Relief,  or  Yoga  ●  Search  retreat  programs  by  keyword  ●  Filter  packages  by  duration,  budget,  or  retreat  category  ●  Compare  retreat  programs  and  package  details  ●  View  retreat  descriptions,  ratings,  and  included  activities  ●  View  pricing  and  duration  before  booking  ●  Book  retreat  packages  directly  from  the  screen  ●  Navigate  through  multiple  retreat  package  pages  
Field  Description  
...
Admin  can  do  on  this  screen  
●  Monitor  guest  arrivals  and  check-in  activities  in  real  time  ●  View  all  guests  arriving  on  the  current  day  ●  Track  check-in  progress  and  room  assignment  status  ●  Manage  VIP  guests  and  priority  arrivals  ●  View  early  check-in  and  late  arrival  requests  ●  Access  detailed  guest  booking  and  payment  information  ●  Confirm  guest  identity  and  registration  details  ●  Monitor  room  availability  and  preparation  status  ●  Coordinate  reception  and  housekeeping  operations  ●  Print  registration  forms  or  check-in  documents  ●  Send  guest  notifications  and  check-in  confirmations  ●  View  recent  operational  notifications  and  alerts  ●  Perform  quick  actions  related  to  check-in  operations  
...
Admin  can  do  on  this  screen  
●  Monitor  room  availability  and  occupancy  status  in  real  time  ●  View  rooms  that  are  available,  occupied,  under  maintenance,  or  being  cleaned  ●  Track  check-in  and  check-out  schedules  for  each  room  ●  Monitor  housekeeping  and  cleaning  progress  ●  View  guest  information  assigned  to  occupied  rooms  ●  Manage  room  maintenance  requests  and  repair  schedules  ●  Search  rooms  by  room  number,  type,  floor,  or  status  ●  Filter  room  lists  based  on  room  condition  or  housekeeping  status  ●  Assign  housekeeping  tasks  for  room  cleaning  ●  Mark  rooms  as  ready,  occupied,  or  under  maintenance  ●  Monitor  room  occupancy  statistics  and  floor  utilization  ●  Access  detailed  room  information  and  booking  history  ●  View  urgent  room  alerts  and  operational  warnings  
Field  Description  
...
Admin  can  do  on  this  screen  
●  Monitor  all  inventory  and  warehouse  items  in  the  resort  ●  Track  stock  quantity  and  warehouse  value  in  real  time  ●  View  items  that  are  available,  low  stock,  or  out  of  stock  ●  Search  inventory  items  by  name  or  item  code  ●  Filter  inventory  by  category,  storage  location,  or  status  ●  Add  new  inventory  items  into  the  warehouse  system  ●  Update  stock  quantity  and  inventory  information  ●  Manage  import  and  export  inventory  transactions  ●  Track  inventory  movement  and  warehouse  history  ●  Monitor  inventory  alerts  for  low  stock  items  ●  View  detailed  information  for  each  inventory  item  ●  Export  inventory  reports  to  Excel  
...
●  Manage  operational  supplies  for  Spa,  Rooms,  F&B,  and  Maintenance  departments  
Field  Description  
Field  Name  Description  
...
Admin  can  do  on  this  screen  
●  View  and  manage  all  resort  employees  ●  Monitor  employee  working  status  in  real  time  ●  Search  employees  by  name  or  employee  ID  ●  Filter  employees  by  department,  position,  or  working  status  ●  Add  new  employees  to  the  system  ●  Edit  employee  information  and  job  assignments  ●  Monitor  employee  schedules  and  current  shifts  ●  View  department  workforce  distribution  ●  Export  employee  lists  to  Excel  ●  Track  employees  who  are  working,  on  leave,  probation,  or  unassigned  
...
●  Manage  staff  information  for  Spa,  Receptionist,  Chef,  Housekeeping,  and  Maintenance  
departments
 ●  Remove  or  deactivate  employee  accounts  if  necessary  
Field  Description  
Field  Name  Description  
...
# 01  components  Contains  reusable  UI  components  of  the  application,  such  as  buttons,  inputs,  modals,  layouts,  etc.  These  components  can  be  used  across  various  pages.  02  utils  Contains  utility  functions  and  logic  unrelated  to  the  UI,  such  as  data  processing  functions,  validation,  date  formatting,  and  API  connection  utilities.  03  assets  Stores  static  resources  of  the  application,  such  as  images,  icons,...  These  files  are  commonly  used  by  components  and  pages.  04  pages  Contains  the  application’s  pages,  where  each  page  is  a  complete  user  interface  screen.  For  example,  the  Home  page,  About  page,  Profile  page,  or  any  other  navigable  page.  05  config  Contains  configuration  files  of  the  application,  including  API  connection  information,  environment  variables,  or  general  settings  used  throughout  the  application.
...
ID  and  Name:  UC-01  –  Register  Account  /  Log  In   
...
Business  Rules:  BR-01  –  Unique  Email  
BR-02  –  Email  Verification  
BR-22  –  Account  Lock  Restriction  
Other  Information:  
...
ID  and  Name:  UC-02  –  View  Resort  Information   
...
Business  Rules:  BR-03  –  Public  Information  Access   
Other  Information:  
...
ID  and  Name:  UC-03  –  Filter  Retreat  Packages    
Primary  Actor:  Guest   Secondary  Actors:  None   
...
Priority:  High   
Frequency  of  Use:  High   
Business  Rules:  BR-04  –  Active  Package  Availability   
...
Priority:  High   
Frequency  of  Use:  High   
Business  Rules:  BR-12  –  Check-in  Validation  
BR-13  –  Villa  Occupancy  Update  
Other  Information:  
...
Priority:  High   
Frequency  of  Use:  High   
Business  Rules:  BR-14  –  Villa  Release  Update  
BR-15  –  Invoice  Generation  
Other  Information:  
...
ID  and  Name:  UC-06  –  Manage  Villa  Status  
...
Normal  Flow:  1.  The  user  clicks  on  the  specific  booking  ID  or  the  "View  Details"  button  within  the  Booking  List  view.  2.  The  system  captures  the  target  Booking  ID  and  sends  a  query  request  to  the  database  backend.  3.  The  system  executes  an  authorization  check  to  verify  access  rights  (ensuring  customers  can  only  view  their  own  reservations  while  authorized  staff  can  access  all  guest  bookings).  4.  The  system  retrieves  and  displays  the  following  detailed  sections  on  the  interface:  ○  General  Information:  Booking  ID,  creation  date,  and  current  booking  status  (e.g.,  Confirmed,  Paid,  Checked-In,  Completed).  ○  Accommodation  Details:  Villa/Room  type,  Check-in  date,  Check-out  date,  and  the  exact  count  of  adults/children.  ○  Personalized  Wellness  Itinerary:  Scheduled  time  slots  for  included  health  activities  (e.g.,  Yoga  sessions,  meditation  classes,  spa  therapies,  and  nutritional  consultations).  ○  Financial  Summary:  Total  cost,  deposit  amount  paid,  remaining  balance  due,  and  the  selected  payment  method.  5.  The  user  reviews  the  details  and  can  either  click  "Back"  to  return  to  the  list  or  proceed  with  secondary  actions  (e.g.,  Export  Receipt,  Cancel  Booking  -  if  within  the  eligible  cancellation  period).  
...
ID  and  Name:  UC08  –  Book  Extra  Spa  Service  
...
## 2.  The  resort’s  resource  allocation  logs  (therapist  schedule  and  treatment  room  availability)  are  locked  for  that  time  frame.  3.  The  extra  service  cost  is  appended  to  the  customer’s  pending  room  bill/invoice.  4.  The  resort’s  resource  allocation  logs  (therapist  schedule  and  treatment  room  availability)  are  locked  for  that  time  frame.  5.  The  extra  service  cost  is  appended  to  the  customer’s  pending  room  bill/invoice.
...
ID  and  Name:  UC09  –  View  Arrivals  Dashboard   
...
ID  and  Name:  UC10  –  Order  Extra  F&B  Items   
...
ID  and  Name:  UC11  –  Complete  Dietary  &  Health  Profile   
...
ID  and  Name:  UC12  –  Schedule  Spa  Therapy  Session  
Primary  Actor:  Customer  /  Receptionist  /  Spa  Staff   
Secondary  Actor:   System  
...
ID  and  Name:  UC-13  –  Book  Retreat  Package    
...
Normal  Flow:  1.  Customer  browses  retreat  packages.  2.  System  displays  active  packages  only  (BR-04).  3.  Customer  selects  a  package.  4.  Customer  selects  arrival  and  departure  dates.  5.  System  validates  villa  availability  (BR-06).  6.  Customer  confirms  booking  information.  7.  System  calculates  required  deposit.  8.  Customer  submits  payment.  9.  Payment  gateway  processes  transaction.  10.  System  receives  payment  confirmation.  11.  System  confirms  booking  according  to  deposit  requirements  (BR-05).  12.  System  displays  booking  confirmation.  Alternative  Flows:  A1.  Customer  chooses  another  package   →  System  displays  selected  package  details.  
A2.  Customer  changes  booking  dates   →  System  rechecks  availability.  
Exceptions:  E1.  Selected  package  is  inactive.  →  System  rejects  booking.  
...
E2.  Villa  unavailable.  →  System  requests  another  selection.  
E3.  Deposit  payment  fails.  →  Booking  remains  Pending.  
 Priority:  High  
Frequency  of  Use:  High    
Business  Rules:  BR-04  –  Active  Package  Availability.   
BR-05  –  Deposit  Requirement.   
BR-06  –  Villa  Availability  Validation.   
BR-30  –  Booking  Timeline  Consistency.   
...
ID  and  Name:  UC-14  –  View  Booking  Details   
...
→  System  displays  error  message.   
 Priority:  Medium   
Frequency  of  Use:  High  
Business  Rules:  BR-30  –  Booking  Timeline  Consistency   
...
ID  and  Name:  UC-15  –  Manage  Profile   
Primary  Actor:  Customer   Secondary  Actors:  System  Administrator   
...
→  Deletion  request  process  is  skipped.   
Exceptions:  E1.  Invalid  data  
→  System  rejects  update  and  displays  validation  message.   
 Priority:  Medium   
Frequency  of  Use:  Medium   
Business  Rules:  BR-20  –  Sensitive  Data  Deletion   
...
ID  and  Name:  UC-16  –  Pre-select  Daily  Meals   
...
→  System  updates  meal  plan.   
Exceptions:  E1.  Submission  after  cut  off  time  
→  System  rejects  submission.   
 Priority:  Medium   
Frequency  of  Use:  High   
Business  Rules:  BR-10  –  Meal  Selection  Deadline  
BR-11  –  Allergy  Warning  
BR-30  –  Booking  Timeline  Consistency  
...
ID  and  Name:  UC-17  –  Submit  Review  &  Rating    
...
## 6.  Customer  enters  comments.  7.  Customer  submits  review.  8.  System  validates  review.  9.  System  stores  review.  10.  System  displays  confirmation.  Alternative  Flows:              A1.  Customer  edits  review  before  submission
            →  System  updates  review  content.   
Exceptions:              E1.  Stay  not  completed            →  Review  submission  is  rejected.  
            E2.  Review  already  exists            →  Duplicate  review  is  rejected.  
Priority:  Medium   
Frequency  of  Use:  Medium   
Business  Rules:  BR-18  –  Review  Eligibility  
BR-19  –  Single  Review  Per  Booking  
...
ID  and  Name:  UC-18  –  View  Daily  Schedule   
...
## 3.  System  retrieves  assigned  sessions.  4.  System  retrieves  related  guest  health  notes.  5.  System  displays  schedule  information.  6.  System  displays  therapist  assignments  validated  by  availability  rules  (BR-08).   Alternative  Flows:          A1.  No  assigned  sessions
       →  System  displays  empty  schedule.   
Exceptions:          E1.  Unauthorized  access  
        →  System  denies  access.   
 Priority:  High  
Frequency  of  Use:  High   
Business  Rules:  BR-08  –  Therapist  Availability  
BR-21  –  Role-Based  Access  Control  
...
ID  and  Name:  UC-19  –  Update  Session  Status   
Primary  Actor:  Spa  Therapist  /  Yoga  Instructor   
Secondary  Actors:  System  Administrator   
...
5.Therapist  submits  update.  6.System  validates  assignment.  7.System  updates  session  status.  8.System  records  status  history.  9.System  displays  confirmation.  .  Alternative  Flows:  A1.  Session  marked  No  Show  
           →  System  records  attendance  exception.   
Exceptions:  E1.  Therapist  not  assigned  
            →  System  rejects  update.   
Priority:  High  
Frequency  of  Use:  High    
Business  Rules:  BR-17  –  Session  Status  Update  
BR-21  –  Role-Based  Access  Control  
...
ID  and  Name:  UC20  –  View  Daily  Meal  Prep  Dashboard   
...
ID  and  Name:  UC21  –  Update  Meal  Order  Status  
Primary  Actor:  Chef  /  F&B  Staff   Secondary  Actors:  System  
...
ID  and  Name:  UC22  –  Manage  Staff  Accounts  &  Roles  
...
ID  and  Name:  UC23  –  Manage  Villa  &  Room  Master  Data  
...
ID  and  Name:  UC24  –  Manage  Resort  &  Yoga  Services  Master  Data  
...
ID  and  Name:  UC25  –  Manage  Retreat  Packages  Master  Data  
Primary  Actor:  Admin   Secondary  Actors:   
...
ID  and  Name:  UC26  –  Audit  Invoice  Ledger  &  Transactions   
...
Exceptions:  E1.  Invalid  quantity  entered.  E2.  Database  update  failure.   Priority:  High  Frequency  of  Use:  High  Business  Rules:  BR-21  –  Role-Based  Access  Control  BR-25  –  Non-Negative  Inventory  Other  Information:  1.  Inventory  includes  resort  supplies,  spa  products,  food  ingredients,  cleaning  materials,  and  maintenance  equipment.  2.  The  system  may  generate  low-stock  warnings  for  inventory  monitoring.  Assumptions:  1.  Inventory  quantities  are  updated  whenever  stock  movements  occur.  2.  Authorized  personnel  maintain  inventory  records  regularly.  3.  All  inventory  items  have  unique  identifiers.   4.2.30  Register  New  Inventory  Item  
ID  and  Name:  UC-30  –  Register  New  Inventory  Item  Primary  Actor:  Business  Manager   Secondary  Actors:  System  Administrator   Description:  Allows  the  business  manager  to  register  a  new  inventory  item  into  the  resort  inventory  system.  Trigger:  Manager  clicks  "Add  New  Inventory  Item".  
...
Exceptions:  E1.  Feedback  record  not  found.  E2.  Notification  service  unavailable.   Priority:  High  Frequency  of  Use:  High  Business  Rules:  BR-18  –  Review  Eligibility  BR-19  –  Single  Review  Per  Booking  BR-21  –  Role-Based  Access  Control  Other  Information:  1.  Feedback  records  may  include  ratings,  reviews,  suggestions,  complaints,  and  manager  responses.  2.  Complaint  history  is  retained  for  service  quality  improvement  and  reporting  purposes.  Assumptions:  1.  Customer  feedback  originates  from  legitimate  completed  bookings.  
...
ID  and  Name:  UC-32  –  Manage  Staff  Shift  Scheduling  &  Attendance   Primary  Actor:  Business  Manager   Secondary  Actors:  Staff  Member,  System  
...
Exceptions:  E1.  Staff  scheduling  conflict  detected.  E2.  Staff  member  unavailable.   Priority:  High  Frequency  of  Use:  High  Business  Rules:  BR-21  –  Role-Based  Access  Control  BR-28  –  Shift  Conflict  Prevention  Other  Information:  1.  Shift  schedules  may  be  displayed  in  calendar  format.  
