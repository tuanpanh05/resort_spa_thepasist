...
UPDATE dbo.retreat_packages SET name = N'5-day Detox Journey', package_name = N'5-day Detox Journey', description = N'Gói giải độc cơ thể toàn diện 5 ngày 4 đêm, bao gồm ẩm thực dưỡng sinh riêng biệt và 3 buổi trị liệu chuyên sâu.', duration_text = N'5 ngày 4 đêm', goal = N'Thải độc (Detox)', includes = N'Tắm Ngâm Lá Thảo Dược Dao Đỏ;Massage Trị Liệu Đá Núi Lửa;Liệu Trình Trẻ Hóa Da Tự Nhiên' WHERE package_id = 1;
UPDATE dbo.retreat_packages SET name = N'Mindfulness & Yoga Weekend', package_name = N'Mindfulness & Yoga Weekend', description = N'Gói thiền định và yoga phục hồi tinh thần 3 ngày 2 đêm, hỗ trợ giảm stress và tái tạo năng lượng.', duration_text = N'3 ngày 2 đêm', goal = N'Yoga & Thiền', includes = N'Tắm Ngâm Lá Thuốc Dao Đỏ;Massage Trị Liệu Ấn Huyệt;Liệu Trình Trị Liệu Cá Nhân' WHERE package_id = 2;
UPDATE dbo.retreat_packages SET name = N'Weight Loss & Slimming Journey', package_name = N'Weight Loss & Slimming Journey', description = N'Liệu trình giảm cân & thon gọn dáng vóc 7 ngày 6 đêm với chế độ ăn uống khoa học kết hợp bài tập đốt mỡ.', duration_text = N'7 ngày 6 đêm', goal = N'Thải độc (Detox)', includes = N'Tư Vấn Thực Đơn Giảm Cân;Tập Luyện PT 1-1 Cá Nhân;Massage Thải Độc Cơ Học' WHERE package_id = 3;
UPDATE dbo.retreat_packages SET name = N'Deep Stress Relief & Forest Bathing', package_name = N'Deep Stress Relief & Forest Bathing', description = N'Trải nghiệm giảm căng thẳng và kết nối thiên nhiên sâu qua hoạt động tắm rừng kết hợp trị liệu âm thanh.', duration_text = N'2 ngày 1 đêm', goal = N'Giảm căng thẳng (Stress Relief)', includes = N'Tắm Rừng Phục Hồi Sinh Thái;Trị Liệu Âm Thanh Chuông Xoay;Massage Đá Muối Himalaya' WHERE package_id = 4;
UPDATE dbo.retreat_packages SET name = N'Spine Recovery & Physical Therapy', package_name = N'Spine Recovery & Physical Therapy', description = N'Gói trị liệu phục hồi cột sống chuyên sâu 4 ngày 3 đêm, chẩn đoán bởi bác sĩ chuyên khoa xương khớp.', duration_text = N'4 ngày 3 đêm', goal = N'Chữa lành & Trị liệu', includes = N'Khám Cột Sống Bác Sĩ Chuyên Khoa;Nắn Chỉnh Cột Sống Chuyên Sâu;Tắm Ngâm Thảo Dược Cổ Truyền' WHERE package_id = 5;
