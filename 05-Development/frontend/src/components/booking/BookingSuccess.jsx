...
export default function BookingSuccess({
  ...
  return (
    <div className="bg-white border border-primary-100 max-w-2xl mx-auto p-8 sm:p-12 text-center shadow-md animate-fade-in relative overflow-hidden rounded-md">
